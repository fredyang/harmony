/*! Harmony v0.1pre © Fred Yang - semanticsworks.com | www.opensource.org/licenses/mit-license.php */(function(g,ha,r){function ya(c,b){for(var a in b)c[a]||(c[a]=b[a])}function Ya(c){return"."===c?"#":ia(c.length+2).join("#")}function za(c){if(c===x)return"";var b=Aa.exec(c);return b?b[1].replace(ja,ka):c}function ka(c){return"#"==c?".":ia(c.length).join("#")}function la(c,b,a){var d,e=c.lastIndexOf(".");i(a)&&(a=!0);if(a){-1===e?(a="",d=c):(a=c.substring(0,e),d=c.substring(e+1));for(var e=a,a=d,f=0;f<J.length;f++)J[f](e,a,b)}if(!U(b))for(d in b){for(var e=c,a=d,f=b[d],m=0;m<J.length;m++)J[m](e,
a,f);la(c+"."+d,b[d],!1)}}function Ba(c,b){var b=y(b),a=A[b];a||(A[b]=a=[]);a.pushUnique(c)}function Ca(c,b){var b=y(b),a=A[b];a.remove(c);a.length||delete A[b]}function Da(c){return(c=Za.exec(c))&&c[1]||""}function Y(){return!1}function z(){return!0}function Z(c,b,a,d,e){this.publisher=B(c);this.originalPublisher=B(b);this.originalType=this.type=a;this.proposed=d;this.removed=e}function Ea(c){var b=c.workflow,a=b.getName,b=b.getParas,c=c.publisher;return b?c[a](b):l(c[a])?c[a]():c[a]}function Fa(c,
b){var a=b.workflow,d=a.setName;(a=a.setParas)?this[d](a,c):l(this[d])?this[d](c):this[d]=c}function Ga(c,b,a){var d=K.getId(b);return g.map(c.split(L),function(b){return j(a)?b+"."+x+"."+d+"."+a:b+"."+x+"."+d+"."+K.getId(a)}).join(" ")}function B(c){return j(c)?h(c):c==M?null:q(c)&&!c.nodeType?c:g(c)}function $a(c){return"."==c?"\\.":".*"}function Ha(c){var b,a,d;d=c.publisher.subsToMe();for(a=0;a<d.length;a++){b=d[a];var e=c,f;a:{f=b.eventTypes;var m=c.type,g=void 0,h=void 0,i=h=g=void 0,j=void 0;
if("*"===f)f="*";else{f=f.split(L);for(j=0;j<f.length;j++)if(h=f[j],h=(i=Ia.test(h))?h.replace(Ia,""):h,h=h.replace(ab,$a),h=i?"^"+h:"^"+h+"$",g=new H(h),g=g.test(m))if(i){if(i="^"==h?m:H.rightContext,!i||!i.contains(".")){f=f[j];break a}}else{f=f[j];break a}f=void 0}}e.matchedType=f;c.matchedType&&$(B(b.subscriber),b.workflow,c);if(c.isImmediatePropagationStopped())return}if(!c.isCascadeStopped()&&(b=A[c.publisher.path]))for(d=0;d<b.length;d++){a=p(b[d],c.originalPublisher.path,c.type);if(a.isImmediatePropagationStopped()||
a.isImmediatePropagationStopped())break;a.hasError()&&c.error()}}function $(c,b,a,d){var e;a.workflow=b;a.subscriber=c;d=i(d)?b.get.call(c,a):b.get.apply(c,[a].concat(d));V(d)?(e=k(!0,{},a),d.done(function(d){b.convert&&(d=b.convert.call(c,d,a));if(!i(d))if(V(d))d.done(function(a){aa(c,b,a,e)});else return aa(c,b,d,a)})):(b.convert&&(d=b.convert.call(c,d,a)),i(d)||(V(d)?(e=k(!0,{},a),d.done(function(a){aa(c,b,a,e)})):aa(c,b,d,a)))}function aa(c,b,a,d){i(a)||(b.set&&b.set.call(c,a,d),b.finalize&&b.finalize.call(c,
a,d))}function N(c){c.publisher=B(c.currentTarget);c.originalPublisher=B(c.target);var b=B(c.data.subscriber),a=c.data.workflow;delete c.data;1<arguments.length?$(b,a,c,o.call(arguments,1)):$(b,a,c)}function Ja(c,b,a,d){c=c||"";if(j(c)){var e,f=c.split(L),m;if(1==f.length)if(c.startsWith("*")){e=O[c.substr(1)];if(!e)throw"common workflow "+c+" does not exist";e=k({},e)}else if(c.startsWith("#")?(e=c.substr(1),e=j(a)?v(a,e):j(b)?v(b,e):e,e=n.raw(e)):e=void 0,e)if(l(e))e=k({get:e,options:d},e);else if(q(e)&&
e.get)e=k({options:d},e);else throw"missing handler";else if(!i(b)&&!i(a)){e=j(b);f=j(a);if(e)c={get:"get",set:c||"set"};else if(f)if(c)c={get:c,set:"set"};else if(c=n.raw(a),l(c))c={get:n.raw(a)};else{if(!q(c)||!c.get)throw"missing handler";}else c={get:c,set:c};e=c}else throw"invalid handler";else{e={};for(var g=0;g<ba.length;g++)c=f[g],m=ba[g],c&&("_"!==c&&"null"!=c)&&(e[m]=c)}c=e}else if(l(c))c=k({get:c,options:d},c);else if(q(c)&&c.get)c=k({options:d},c);else throw"invalid workflow expression";
e=c;f=e.initialize;if(j(f))if(f.startsWith("*")){if(f=h.activity.initialize[f.substring(1)],!f)throw"initialize activity does not exist!";}else{var na=f;if(!n.raw(na))throw"initialize activity does not exist at path "+na;f=function(a,b,c,d){n.set(na,a,b,c,d)}}f?(f(B(b),B(a),e,d),delete e.initialize):i(d)||(e.options=d);ca("get",c,b,a);ca("set",c,b,a);W(c,"convert");W(c,"finalize");return c}function Ka(c){var b;if(j(c)){var a=c.split(L),d;if(1<a.length)for(var c={},e=0;e<ba.length;e++)b=a[e],d=ba[e],
b&&("_"!==b&&"null"!=b)&&(c[d]=b);else throw"invalid workflow type";b=c}else if(l(c)||q(c)&&c.get)b=c,l(c)&&(b=k({get:c},b));else throw"invalid workflow expression";W(b,"initialize");ca("get",b);ca("set",b);W(b,"convert");W(b,"finalize");return b}function ca(c,b,a,d){var e=b[c];if(e&&j(e)){var f=h.activity[c];if(e.startsWith("*")){if(e=e.substr(1),b[c]=f[e],!b[c])throw e+" does not exists "+c+" Activity";}else if(e=e.split("*"),b[c]="get"==c?Ea:Fa,b[c+"Name"]=e[0],e[1]&&(b[c+"Paras"]=e[1]),!i(a)&&
!i(d)){var b=e[0],a="get"==c?a:d,m;j(a)?oa[b]||(m=!0):a.nodeType?P[b]||(m=!0):b in a||(m=!0);if(m)throw("get"==c?"publisher":"subscriber")+" does not have a member "+b;}}}function W(c,b){var a=c[b];if(j(a))if(a.startsWith("*")){if(c[b]=h.activity[b][a.substr(1)],!c[b])throw a+"Activity does not exists";}else c[b]=function(){return n.raw(a).apply(this,arguments)}}function La(c){if(q(c)){if(!K.getId(c))return;K.unMark(c)}w.removeBy(c)}function pa(c,b){if("_"!==b)return b&&b.startsWith("_")?b.substr(1):
c||b}function D(c,b,a,d){var e,f;if(c)if(c.nodeType){if(d=c,c=g.trim(g(d).attr(E.subsAttr))){b=new D;b.elem=d;a=b;a:{for(d=g(d);(d=d.parent())&&d.length;)if(e=d.hmData("ns"),!i(e)){d=e;break a}d=""}a.ns=d;return new D(c,b)}}else{if(!b)return b=new D,b.elem={},new D(c,b);this.sub=[];this.pub=[];for(this.groups=[];f=bb.exec(c);){var m=f[1],h=f[2];f=f[3];var j={key:h,value:f};m?this["$"==m?"pub":"sub"].push(j):"ns"==h?e=f:this.groups.push(j)}this.ns=v(v(b.ns,a),e);this.text=c;this.elem=b.elem;this.subscriptions=
...
{constructor:sa,get:function(c){var b;if(b=this.accessor(c,!0)){if(l(b.hostObj))return b.hostObj.apply(this.cd(".."),o.call(arguments));b=!b.index?b.hostObj:b.hostObj[b.index];return l(b)?b.apply(this.cd(c).cd(".."),o.call(arguments,1)):b}},getJson:function(){return JSON.stringify(this.get.apply(this,o.call(arguments)))},raw:function(c,b){var a;l(c)&&(b=c,c="");if(b)return a=this.accessor(c),a.index in a.hostObj?this.update(c,b,a):this.create(c,b,a);if(a=this.accessor(c,!0))return!a.index?a.hostObj:
a.hostObj[a.index]},set:function(c,b,a){if(1==arguments.length){if(""==this.path)throw"root object can not changed";n.set(this.path,c,b);return this}var d=o.call(arguments);if(S(c)){if(2==arguments.length)return n.set(c,this.path,b),this}else a=b,b=c,c=!1;var e=this.accessor(b),f=e.hostObj[e.index];return l(f)?(f.apply(this.cd(b).cd(".."),o.call(d,1)),this):e.index in e.hostObj?this.update(c,b,a,e):this.create(c,b,a,e)},accessor:function(c,b){0===c&&(c="0");var a,d,e=ta,f=this.getPath(c),m=y(f,!0),
g=m.split(".");if(1===g.length)d=m;else{d=g[g.length-1];for(a=0;a<g.length-1&&!(e=e[g[a]],e===r);a++);}if(U(e)){if(b)return;throw"invalid update on unreachable node '"+G(f)+"'";}return{physicalPath:m,hostObj:e,index:d}},create:function(c,b,a,d){S(c)||(d=a,a=b,b=c,c=!1);var d=d||this.accessor(b),b=d.physicalPath,e=d.hostObj,f=d.index,g=F(e);if(g&&ua(f)){if(f>e.length)throw"you can not add item with hole in array";}else if(f in e)throw"value at path: '"+G(d.physicalPath)+"' has been defined, try use update method instead";
if(!c&&p(b,b,"beforeCreate",a).hasError())return!1;g&&ua(f)?f==e.length?e[f]=a:f<e.length&&e.splice(d.index,0,a):e[d.index]=a;p(b,b,"afterCreate",a);la(b,a);return this},extend:function(c,b){var a;b?a=this.cd(c):(b=c,a=this);for(var d in b)a.set(d,b[d]);return this},update:function(c,b,a,d){if(1==arguments.length){if(""==this.path)throw"root object can not updated";n.update(this.path,c);return this}if(S(c)){if(2==arguments.length)return n.update(c,this.path,b),this}else d=a,a=b,b=c,c=!1;d=d||this.accessor(b);
...
this.path,"afterUpdate",this.get().sortObject(c,b))},reference:function(){for(var c=0;c<arguments.length;c++)Ba(this.path,arguments[c]);return this},dereference:function(){for(var c=0;c<arguments.length;c++)Ca(this.path,arguments[c]);return this},isEmpty:function(c){c=this.get(c);return!c?!0:!F(c)?!1:0===c.length},isShadow:function(){return this.path.startsWith(x)},toJSON:function(c){return JSON.stringify(this.get(c))},compare:function(c){if(c)if(c=ea(c),j(c)){if(this.get()==c)return!0;try{return eval("this.get()"+
c)}catch(b){return!1}}else return this.get()==c;else return this.isEmpty()},saveLocal:function(c){C.local(this.getPath(c),this.get());return this},getLocal:function(c){return C.local(this.getPath(c))},restoreLocal:function(c){n.set(this.getPath(c),this.getLocal(c));return this},clearLocal:function(c){C.local(this.getPath(c),r);return this}};var J=[function(c,b,a){if(l(a)&&(!a.name||!a.name.startsWith("_"))){for(var b=c?c+"."+b:b,d=a.toString(),e,a=[];e=db.exec(d);)a.pushUnique(e[2]);for(d=0;d<a.length;d++)Ba(b,
c?v(c,a[d]):a[d])}}],M={},va=function b(a){var d;if(!(this instanceof b))return d=new b(M),b.apply(d,arguments);if(arguments[0]===M)return this;this.initialize.apply(this,arguments);return this},T;k(va.prototype,{callProto:function(b){return this.constructor.prototype[b].apply(this,o.call(arguments,1))},callBase:function(b){T=T||this;if(T=T.constructor.__super__){var a=T[b].apply(this,o.call(arguments,1));T=null;return a}},initialize:function(b){k(this,b)},toJSON:function(){var b=k(!0,{},this),a;
for(a in b)a.startsWith("__")&&delete b[a];return b}});k(va,{list:function(b){var a,d,e=[],f;if(!i(b))if(F(b)){f=b.itemIsObject;for(a=0;a<b.length;a++)d=b[a],e.push(f||!F(d)?new this(d):this.apply(null,d))}else e.push(b);return e},extend:function(b,a){var d,e=this;d=b&&b.hasOwnProperty("constructor")?b.constructor:function ma(){var a;if(!(this instanceof ma))return a=new ma(M),ma.apply(a,arguments);if(arguments[0]===M)return this;e.apply(this,arguments);return this};k(d,e,a);var f=function(){this.constructor=
d};f.prototype=e.prototype;d.prototype=new f;b&&k(d.prototype,b);d.__super__=e.prototype;return d}});k(h,{Class:va,util:C={toPhysicalPath:y=function(b,a){for(var d,e="",f="",g;d=jb.exec(b);)b=H.rightContext,f=H.leftContext,"."==d[0]?e?(e==x&&(a&&!X[f])&&(g=f.replace(ja,ka),i(n.get(g))||(X[f]={})),e=e+"."+f):e=f:(e?(d=(e?e.replace(kb,Ya):e)+"#"+f,g=e+"."+f):g=f?d=f:d="",e=x+(d?"."+d:""),a&&(!X[d]&&e!=x&&!i(n.get(g)))&&(X[d]={}));return!b?e:e?e+"."+b:b},toLogicalPath:G=function(b){var a;return b===
...
r},isPrimitive:U=function(b){return null===b||typeof b in cb},isString:j=function(b){return"string"===typeof b},isObject:q=function(b){return"object"===g.type(b)},isBoolean:S=function(b){return"boolean"===typeof b},toTypedValue:ea=function(b){if(j(b)){b=g.trim(b);try{b="true"===b?!0:"false"===b?!1:"null"===b?null:"undefined"===b?r:ua(b)?parseFloat(b):gb.test(b)?g.parseJSON(b):b}catch(a){}}return b},isPromise:V=function(b){return!(!b||!b.promise||!b.done||!b.fail)},clearObj:Ta=function(b){if(U(b))return null;
for(var a in b)eb.call(b,a)&&(b[a]=Ta(b[a]));return b},clone:function(b,a){return U(b)?b:F(b)?b.slice(0):l(b)?b:k(!!a,{},b)},local:function(b,a){if(1==arguments.length)return JSON.parse(localStorage.getItem(b));i(a)?localStorage.removeItem(b):localStorage.setItem(b,JSON.stringify(a))},toString:function(b){return null===b||b===r?"":""+b},encodeHtml:function(b){var a=document.createElement("div");a.appendChild(document.createTextNode(b));return a.innerHTML},_referenceTable:A},onAddOrUpdateNode:function(b){return b?
...
z},isCascadeStopped:Y,isPropagationStopped:Y,isImmediatePropagationStopped:Y,hasError:Y,level:0};p=function(b,a,d,e,f){e=new Z(b,a,d,e,f);Ha(e);if(!e.isPropagationStopped()&&e.publisher.path){e.isDependent()&&(e.originalPublisher.path=e.publisher.path);do e.publisher.path=e.publisher.pathContext(),e.level++,e.type=e.originalType+"."+e.level,Ha(e);while(!e.isPropagationStopped()&&e.publisher.path)}e.type=d;e.originalPublisher.path=a;e.publisher.path=b;return e};var wa=function(b,a){j(b)&&(b=y(b));
for(var d=[],e=0,f;e<I.length;e++)f=I[e],a(f,b)&&d.push(f);return d},I=[];w={getByPublisher:function(b){return wa(b,function(a,b){return a.publisher==b})},getBySubscriber:function(b){return wa(b,function(a,b){return a.subscriber==b})},getBy:function(b){return wa(b,function(a,b){return a.subscriber==b||a.publisher==b})},getAll:function(){return I},add:function(b,a,d,e){if(j(a))for(var f=d.split(L),g=0;g<f.length;g++){var h=this.special[f[g]];h&&h.setup&&h.setup(b,a)}I.push({publisher:a,subscriber:b,
eventTypes:d,workflow:e})},removeBy:function(b){var a,d,e,f=[];for(a=I.length-1;0<=a;a--)if(e=I[a],d=e.workflow,b===e.publisher||b===e.subscriber||j(b)&&(j(e.publisher)&&e.publisher.startsWith(b+".")||j(e.subscriber)&&e.subscriber.startsWith(b+".")))j(e.publisher)||(d.delegateSelector?g(e.publisher).undelegate(d.delegateSelector,e.eventTypes,N):g(e.publisher).unbind(e.eventTypes,N)),f.push(I.splice(a,1)[0]);for(a=f.length-1;0<=a;a--)if(e=f[a],j(e.publisher))for(var h=e.eventTypes.split(L),b=0;b<h.length;b++)(d=
this.special[h[b]])&&d.teardown&&d.teardown(e.subscriber,e.publisher)},special:{}};k(h,{trigger:p,subscription:w,sub:function(b,a,d,e,f,m){b instanceof h&&(b=b.path);a instanceof h&&(a=a.path);j(b)&&b.startsWith("$")&&(b=g(b.substr(1)));if(b&&b.jquery)if(!b.length&&!b.selector)b=null;else{b.each(function(b,g){h.sub(g,a,d,e,f,m)});return}j(a)&&a.startsWith("$")&&(a=g(a.substr(1)));if(a&&a.jquery)a.each(function(a,g){h.sub(b,g,d,e,f,m)});else{if(!a&&""!==a)throw"publisher can not be null";if(!d)throw"eventTypes can not be null";
if("_"===b||"null"==b||null===b)b=M;"_"===f&&(f=r);var i=j(a),k=j(b);K.mark(a);K.mark(b);i&&(a=y(a));k&&(b=y(b));if(i){var n=a,l=d,o=b,i=f,s,p,q,t;t=l.split(" ");for(var u=0;u<t.length;u++)if(k=ob.exec(t[u])){p=t[u];s=+k[1];t.splice(u,1);l=t.join(" ");break}q=Ja(e,n,o,i);l&&w.add(o,n,l,q);p&&(l=function(){var a=new Z(n,n,p);$(B(o),q,a)},s?setTimeout(l,s):l())}else(s=a,i=d,k=b,t=f,u=i.split(" "),u.contains("init")&&(l=!0,i=u.remove("init").join(" ")),u=Ja(e,s,k,t),t={workflow:u,subscriber:k},i)?(i=
Ga(i,s,k),m?(u.delegateSelector=m,g(s).delegate(m,i,t,N)):g(s).bind(i,t,N),w.add(k,s,i,u),l&&(m?g(s).find(m).trigger(i):g(s).trigger(i))):l&&(g(s).one("init",t,N),g(s).trigger("init"))}},handle:function(){return this.sub.apply(this,[null].concat(o.call(arguments)))},workflowType:function(b,a){if(q(b))for(var d in b)O[d]=Ka(b[d]);else return i(b)?O:i(a)?O[b]:O[b]=Ka(a)},activity:{initialize:{},get:{getMember:Ea,getOriginal:function(b){return b.originalPublisher.get()},skipGet:z},set:{setMember:Fa,
...
h.onDeleteNode(La);k(oa,{trigger:function(b,a,d,e){if(!arguments.length)throw"missing arguments";3>=arguments.length&&(e=d,d=a,a=b,b="");var f=this.physicalPath(b);p(f,f,a,d,e);return this},triggerChange:function(b){var a=this.physicalPath(b),b=this.get(b);p(a,a,"afterUpdate",b,b);return this},sub:function(b,a,d,e,f){h.sub(this.path,b,a,d,e,f);return this},handle:function(b,a,d,e){h.sub(null,this,b,a,d,e);return this},subBy:function(b,a,d,e,f){h.sub(b,this.path,a,d,e,f);return this},subsToMe:function(){return w.getByPublisher(this.path)},
subsFromMe:function(){return w.getBySubscriber(this.path)},subscriptions:function(){return w.getBy(this.path)},mapEvent:function(b,a,d){d=d||z;h.handle(this.path,b,function(b){d.call(this,b)&&b.publisher.trigger(a,b.proposed,b.removed)});return this},cacheable:function(b){h.handle(this.getPath(b),"init after*","*saveLocal");return this}});k(P,{sub:function(b,a,d,e,f){this.length&&h.sub(this,b,a,d,e,f);return this},handle:function(b,a,d,e){this.length&&h.sub(null,this,b,a,d,e);return this},subBy:function(b,
a,d,e,f){this.length&&h.sub(b,this,a,d,e,f);return this},subsToMe:function(){return w.getByPublisher(this[0])},subsFromMe:function(){return w.getBySubscriber(this[0])},subscriptions:function(){return w.getBy(this[0])},initView:function(b,a,d){h.sub(this,b,"init",a,d);return this},mapEvent:function(b,a,d,e){d?l(d)||(e=d,d=z):d=z;return this.handle(b,function(b){if(d.call(this,b)){b.type=a;b.eventData=e;b.publisher.trigger(b)}})}});h.newViewEvent=function(b,a,d){if(q(b)){for(var e in b)h.newViewEvent(e,
b[e][0],b[e][1]);return this}var f=function(a){(!0===d||d(a))&&g(a.target).trigger(k({},a,{type:b,currentTarget:a.target}))};if(g.event.special[b])throw"event '"+b+"' has been defined";g.event.special[b]={setup:function(){g(this).bind(a,f)},teardown:function(){g(this).unbind(a,f)}};return this};var pb=g.cleanData;g.cleanData=function(b){g(b).each(function(){La(this)});pb(b)};C.getUniqueViewEventTypes=Ga;C._viewHandlerGateway=N;var bb=/([!$]?)([\w \+\-\*\.]+?):([\w\W]+?)\s*(?:[;]\s*|$)/g,qb=/^([^|]+)(\|(.*))?$/,
rb=/\s*\|\s*/g;E.subsAttr="data-sub";E.autoparseSub=!0;D.prototype={importGroup:function(){var b,a,d,e,f=this.groups;for(b=0;b<f.length;b++)d=f[b],a=d.key,e=qb.exec(d.value),d=e[1],e=e[3],a=h.groups[a],l(a)?a(this.elem,v(this.ns,d),this,pa(this.options,e)):j(a)&&new D(a,this,d,e)},importSubscriptions:function(b){var a,d,e,f,g,h=this[b];for(a=0;a<h.length;a++)d=h[a],f=d.key,d=d.value.split(rb),"sub"==b?(e=d[0],e=e.startsWith("$")?e:v(this.ns,e),g=this.elem):(e=this.elem,g=d[0],g=g.startsWith("$")?
g:v(this.ns,g)),this.appendSub(g,e,f,d[1],ea(pa(this.options,d[2])),d[3])},appendSub:function(b,a,d,e,f,g){this.subscriptions.push({publisher:a,eventTypes:d,subscriber:b,handler:e,options:f,delegate:g})},prependSub:function(b,a,d,e,f,g){this.subscriptions.unshift({publisher:a,eventTypes:d,subscriber:b,handler:e,options:f,delegate:g})},clearSubs:function(){this.subscriptions.splice(0,this.subscriptions.length)}};setTimeout(function(){g(function(){E.autoparseSub&&qa(document.documentElement)})},1);
P.parseSub=function(){return this.each(function(){qa(this)})};var Ua=h("*log",[]);k(h,{groups:{code:function(b,a,d,e){n.get(a,b,a,d,e)},preSub:function(b,a,d,e){d.preSub=function(){n.get(a,b,a,d,e)}},postSub:function(b,a,d,e){d.postSub=function(){n.get(a,b,a,d,e)}}},Group:D,log:function(b,a){Ua.push(a?"<div style='color:"+a+"'>"+b+"</div> ":b)},clearlog:function(){Ua.clear()}});var Q,da={},ra={initialize:"*templateOptions",get:"get",convert:"*dataToMarkup",set:"html",finalize:"*parseSub"};h.activity.initialize.templateOptions=
function(b,a,d,e){if(j(e))e=e.split(","),d.templateId=g.trim(e[0]),d.wrapDataInArray="true"==g.trim(e[1]),d.engineName=e[2];else if(q(e)&&e.templateId)k(d,e);else if(!(d.templateId=a.hmData("embeddedTemplate")))if(b=g.trim(a.html()))b=b.replace(sb,tb),d.templateId="__"+g.uuid++,Q.compile(d.templateId,b),a.hmData("embeddedTemplate",d.templateId),a.empty();else throw"missing template";};var sb=/&lt;|&gt;/g,ub={"&lt;":"<","&gt;":">"},tb=function(b){return ub[b]||""};Na.prototype.get=function(){var b=
this.e.publisher;return b.get.apply(b,o.call(arguments))};h.activity.convert.dataToMarkup=function(b,a){if(b&&(F(b)&&b.length||!F(b))){var d=a.workflow,e;var f=d.templateId,h=d.wrapDataInArray?[b]:b;e=new Na(a);var i=Oa(d.engineName,f),f=g.trim(f);if(i.isTemplateLoaded(f))e=i.render(f,h,e);else if(i.renderAsync)e=i.renderAsync(f,h,e);else{var l=g.Deferred(),d=k(!0,{},e.e),n=k(!0,{},d.publisher),o=k(!0,{},e);d.publisher=n;o.e=d;Q.load(f).done(function(){var a=i.render(f,h,o),b=g(a);l.resolve(b.selector||
!b.length?a:b)});e=l.promise()}if(V(e))return e;j(e)&&(e=g.trim(e));return g(g("<div />").html(e)[0].childNodes)}return""};h.activity.finalize.parseSub=function(b){g(b).parseSub()};h.workflowType({renderContent:ra,renderSelf:Ma("get","replaceWith")});k(h.groups,{"for":"!init:.|*renderContent",forSelf:"!init after*.:.|*renderContent",forChildren:"!init after*. after*.1:.|*renderContent",forAll:"!init after*:.|*renderContent",renderSelf:"!init:.|*renderSelf"});P.renderContent=function(b,a,d){a=a||"";
l(d)&&(d={finalize:d});return this.initView(a,d?k({},ra,d):"*renderContent",b)};P.renderSelf=function(b,a,d){l(d)&&(d={finalize:d});return this.initView(a,d?k({},h.workflowType("renderSelf"),d):"*renderSelf",b)};h.template=Q={defaultEngine:"",engineAdapter:function(b,a){if(!b)return da;if(!a)return da[b];a.isTemplateLoaded=a.isTemplateLoaded||z;da[b]=a;Q.defaultEngine=b},load:function(){throw"not implemented";},compile:function(b,a,d){return Oa(d).compile(b,a)},newTemplateWorkflow:Ma};if(g.render&&
...
set:function(a,d){this[a?"addClass":"removeClass"](d.workflow.className)}}],removeClass:["!init after*:.|*removeClass",{initialize:"*extractClass",get:"*compareTruthy",set:function(a,d){this[a?"removeClass":"addClass"](d.workflow.className)}}],toggleClass:["!init after*:.|*toggleClass",{get:function(a){a.type=="init"?this.addClass(a.publisher.get()):this.removeClass(a.removed).addClass(a.proposed)}}],focus:["!init after*:.|*focus",{get:"*compareTruthy",set:function(a){if(a){var d=this;setTimeout(function(){d.focus().select()},
1)}}}],count:["!init after*:.|*count",function(a){a=a.publisher.get();this.text("length"in a?a.length:a)}],dump:["!init *:.|*dump",function(a){a.type.startsWith("before")||this.html("<span style='color:red'>"+a.publisher.path+" : "+a.publisher.toJSON()+"</span>")}],alert:["$click:.|*alert",function(a){alert(i(a.workflow.options)?this.get():a.workflow.options)}],preventDefault:["$click:_|*preventDefault",function(a){a.preventDefault()}],stopPropagation:["$click:_|*stopPropagation",function(a){a.stopPropagation()}],
confirm:[function(a,d,e,f){h.sub(d,a,"click","*confirm",f)},function(a){var d=i(a.workflow.options)?this&&this.get&&this.get()||E.confirmMessage:a.workflow.options;if(!confirm(d)){a.stopImmediatePropagation();a.preventDefault&&a.preventDefault()}}],hardCode:["$click:.|*hardCode",{initialize:function(a,d,e,f){e.hardCode=ea(f)},get:function(a){this.set(a.workflow.hardCode)}}],"0":["$click:.|*0",function(){this.set(0)}],emptyString:["$click:.|*empty",function(){this.set("")}],"null":["$click:.|*null",
...
function(){this.clear()}],del:["$click:.|*del",function(){this.del()}]},ga;for(ga in Wa){var Xa=Wa[ga];h.groups[ga]=Xa[0];h.workflowType(ga,Xa[1])}k(h.groups,{caption:function(a,d,e,f){g(a).prepend("<option value=''>"+(f||h.get(d))+"</option>")},autofocus:function(a){setTimeout(function(){g(a).focus()},1)},mapEvent:function(a,d,e,f){f=f.split(",");g(a).mapEvent(f[0],f[1],f[2])},mapClick:function(a,d,e,f){f=f.split(",");g(a).mapEvent("click",f[0],f[1])},logPanel:function(a,d,e){var a=g(a),f=a.is("ol")?
a:g("<ol style='font-family: monospace, serif' />").appendTo(a),a=f[0];e.appendSub(a,"*log","init",function(a){for(var a=a.publisher.get(),d=0;d<a.length;d++)f.append("<li>"+a[d]+"</li>")});e.appendSub(a,"*log","afterCreate.1",function(a){f.append("<li>"+a.originalPublisher.raw()+"</li>")});e.appendSub(a,"*log","afterCreate",function(){f.empty()})},clearlog:"clear:/*log",enableLater:"!after*:.|*enable",disableLater:"!after*:.|*disable",html:"!init after*:.|get html *toString",text:"!init after*:.|get text *toString"});
h.newViewEvent({enter:["keyup",function(a){return a.keyCode===13}],esc:["keyup",function(a){return a.keyCode===27}],ctrlclick:["click",function(a){return a.ctrlKey}]})})(jQuery,window);
