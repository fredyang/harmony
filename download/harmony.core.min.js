...
b[e][0],b[e][1]);return this}var f=function(a){(!0===d||d.call(this,a))&&g(a.target).trigger(k({},a,{type:b,currentTarget:a.target}))};if(g.event.special[b])throw"event '"+b+"' has been defined";g.event.special[b]={setup:function(){g(this).bind(a,f)},teardown:function(){g(this).unbind(a,f)}};return this};var pb=g.cleanData;g.cleanData=function(b){g(b).each(function(){La(this)});pb(b)};C.getUniqueViewEventTypes=Ga;C._viewHandlerGateway=N;var bb=/([!$]?)([\w \+\-\*\.]+?):([\w\W]+?)\s*(?:[;]\s*|$)/g,
...
function(){this.clear()}],del:["$click:.|*del;confirm:_|_Do you want to delete this item?",function(){this.del()}]},ga;for(ga in Wa){var Xa=Wa[ga];h.groups[ga]=Xa[0];h.workflowType(ga,Xa[1])}k(h.groups,{caption:function(a,d,e,f){g(a).prepend("<option value=''>"+(f||h.get(d))+"</option>")},autofocus:function(a){setTimeout(function(){g(a).focus()},1)},mapEvent:function(a,d,e,f){f=f.split(",");g(a).mapEvent(f[0],f[1],f[2])},mapClick:function(a,d,e,f){f=f.split(",");g(a).mapEvent("click",f[0],f[1])},
logPanel:function(a,d,e){var a=g(a),f=a.is("ol")?a:g("<ol style='font-family: monospace, serif' />").appendTo(a),a=f[0];e.appendSub(a,"*log","init",function(a){for(var a=a.publisher.get(),d=0;d<a.length;d++)f.append("<li>"+a[d]+"</li>")});e.appendSub(a,"*log","afterCreate.1",function(a){f.append("<li>"+a.originalPublisher.raw()+"</li>")});e.appendSub(a,"*log","afterCreate",function(){f.empty()})},clearlog:"clear:/*log",enableLater:"!after*:.|*enable",disableLater:"!after*:.|*disable",html:"!init after*:.|get html *toString",
text:"!init after*:.|get text *toString"});h.newViewEvent({enter:["keyup",function(a){return a.keyCode===13}],esc:["keyup",function(a){return a.keyCode===27}],ctrlclick:["click",function(a){return a.ctrlKey}]})})(jQuery,window);
